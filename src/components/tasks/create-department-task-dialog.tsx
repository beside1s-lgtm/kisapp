...
import { TaskTypeConfigSection } from './TaskTypeConfigSection';
          ...
          <div className="p-4 sm:p-5 overflow-y-auto flex-1 space-y-4 scrollbar-thin">
            ...
            {taskCategory === 'event' && (
              <EventDetailsSection
                ...
                onRemoveBudgetItem={removeBudgetItem}
              />
            )}
            ...
            <div className="space-y-2.5 pt-1">
              ...
              <TaskTypeConfigSection
                taskType={taskType}
                customSheetUrl={customSheetUrl}
                setCustomSheetUrl={setCustomSheetUrl}
                systemTemplates={systemTemplates}
                selectedTemplateId={selectedTemplateId}
                setSelectedTemplateId={setSelectedTemplateId}
                templateColumns={templateColumns}
                isSavingTemplate={isSavingTemplate}
                onSaveCurrentAsSchoolTemplate={handleSaveCurrentAsSchoolTemplate}
                onTemplateResetToOriginal={handleTemplateResetToOriginal}
                onTemplateClearColumns={handleTemplateClearColumns}
                onTemplateAddColumn={handleTemplateAddColumn}
                onTemplateMoveColumn={handleTemplateMoveColumn}
                onTemplateUpdateColumn={handleTemplateUpdateColumn}
                onTemplateRemoveColumn={handleTemplateRemoveColumn}
