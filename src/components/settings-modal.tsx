      ...
      >
        ...
        <Tabs value={activeMainTab} onValueChange={setActiveMainTab} className="flex-1 flex flex-col min-h-0 overflow-hidden">
          ...
          <OrgSettingsTab
            ...
            toast={toast}
            updateAndSaveOrg={updateAndSaveOrg}
            handleOrgSave={handleOrgSave}
            isSaving={isSaving}
            selectedGradeView={selectedGradeView}
            setSelectedGradeView={setSelectedGradeView}
            newHomeroom={newHomeroom}
            setNewHomeroom={setNewHomeroom}
            newSubjectCategoryName={newSubjectCategoryName}
            setNewSubjectCategoryName={setNewSubjectCategoryName}
            handleHomeroomFileSelect={handleHomeroomFileSelect}
            handleHomeroomUpload={handleHomeroomUpload}
            handleDownloadHomeroomTemplate={handleDownloadHomeroomTemplate}
            selectedHomeroomFile={selectedHomeroomFile}
            isUploading={isUploading}
            duplicatePendingRows={duplicatePendingRows}
            setDuplicatePendingRows={setDuplicatePendingRows}
            duplicateResolvedEmails={duplicateResolvedEmails}
            setDuplicateResolvedEmails={setDuplicateResolvedEmails}
            handleResolveDuplicates={handleResolveDuplicates}
            newCustomDutyRoleName={newCustomDutyRoleName}
            setNewCustomDutyRoleName={setNewCustomDutyRoleName}
            newCustomDutyDept={newCustomDutyDept}
            setNewCustomDutyDept={setNewCustomDutyDept}
            ...
            updateDeptHead={updateDeptHead}
            addDeptMember={addDeptMember}
            removeDeptMember={removeDeptMember}
            assignDutyToMember={assignDutyToMember}
            createAndAssignCustomDuty={createAndAssignCustomDuty}
            removeDutyFromMember={removeDutyFromMember}
            handleDeptFileSelect={handleDeptFileSelect}
            handleDeptUpload={handleDeptUpload}
            handleDownloadDeptTemplate={handleDownloadDeptTemplate}
            selectedDeptFile={selectedDeptFile}
          />
