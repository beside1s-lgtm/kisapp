...
import { Loader2, Eye, RefreshCw, BookOpen } from "lucide-react";
    ...
    return (
        <div className="p-4 md:p-8 space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b pb-4">
                <div>
                    <h1 className="font-headline text-2xl sm:text-3xl font-bold flex items-center gap-3 text-slate-900">
                ...
                <Button 
                    ...
                    className="self-start sm:self-auto h-9 gap-1.5 text-xs font-semibold rounded-xl"
                >
